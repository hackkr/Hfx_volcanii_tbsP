Schmid Lab Final ONPG Calculations and Statistical Analyses
================
Katie Lam & Rylee Hackley
...
\##Reformatting \### Reformats the raw data to wide format, with the
time point in rows, and the plate wells as the column titles. Each
number represents the absorbance value measured by the plate reader.
Also graphs the increase in absorbance over time to identitfy linear
ranges.
...
![](ONPG_files/figure-gfm/sept%20calculations-1.png)<!-- -->
